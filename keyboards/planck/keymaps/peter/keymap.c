...
[_LOWER] = { 
  ...
  { _______  , KC_NO , _______ , KC_NO , _______ , KC_NO  , KC_NO  , KC_NO  , KC_VOLD, KC_VOLU   , KC_VOLD , KC_RIGHT  }
},
...
[_RAISE] = { 
  ...
  {_______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_UNDS, KC_NUBS, _______, _______, _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLD, KC_VOLU, KC_RGHT}
},


[_NUM] = { 
  { RESET   , MU_ON , MU_OFF  , KC_F3  , KC_F4  , KC_NO  , KC_NO, KC_INSERT, KC_NO   , KC_7  , KC_8 , KC_9  } ,
